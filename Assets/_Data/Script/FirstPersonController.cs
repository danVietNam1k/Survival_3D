...
public class FirstPersonController : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        checkGroundPoint = transform.Find("CheckGround");
    ...
    private void CheckGround()
    {
        ...
        if (Physics.CheckSphere(checkGroundPoint.position, 0.3f, checkGround))
        {
...
//        fpc.canSprint = EditorGUILayout.ToggleLeft(new GUIContent("Enable Sprint", "Determines if the player is allowed to sprint."), fpc.canSprint);

//        GUI.enabled = fpc.canSprint;
